            ...
            <div className="list_inner">
              <div className="image" onClick={toggleModalOne}>
                ...
                <div
                  className="main"
                  style={{
                    backgroundImage: `url(${process.env.PUBLIC_URL + "img/news/1.png"
                      })`,
                  }}
                ></div>
              </div>
                ...
                <div className="beny_tm_modalbox_news">
                  ...
                  <div className="box_inner">
                    <div className="description_wrap scrollable">
                      <div className="image">
                        <img src="/img/placeholders/2.png" alt="thumb" />
                        <div
                          className="main"
                          style={{
                            backgroundImage: `url(${process.env.PUBLIC_URL + "img/news/1.png"
            ...
            <div className="list_inner">
              <div className="image" onClick={toggleModalTwo}>
                ...
                <div
                  className="main"
                  style={{
                    backgroundImage: `url(${process.env.PUBLIC_URL + "img/news/2.png"
                      })`,
                  }}
                ></div>
              </div>
                ...
                <div className="beny_tm_modalbox_news">
                  ...
                  <div className="box_inner">
                    <div className="description_wrap scrollable">
                      ...
                      <div className="details">
                        <span>
                          April 07,2021 <a href="#a">Anh Ben</a>
                        </span>
                        <h3 className="title">Why should we use a middleware like Redux Thunk</h3>
                      </div>
                      {/* End details */}
                      <div className="main_content">
                        <div className="descriptions">
